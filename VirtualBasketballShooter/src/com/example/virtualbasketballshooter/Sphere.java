...
public class Sphere {
	...
	private final String fragmentShaderCode =
			...
			"   vec4 lightS = vec4(1.0, 1.0, 1.0, 1.0); " + // the specular highlight is WHITE
	...
	public void draw(float[] mvpMatrix, float [] normalMat, float [] mvMat, float[] mColor) {	// pass in the calculated transformation matrix
